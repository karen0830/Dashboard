...
import { logoutCompany } from '@mock-api/api/api/auth.company';
...
const useJwtAuth = (props) => {
	...
	const signIn = async (credentials) => {
		try {
			...
			const response = await axios.post(authConfig.signInUrl, credentials);
			...
			throw error; // Lanzar el error para que pueda ser manejado por el código que llame a signIn
		}
	};
	...
	const signUp = useCallback(async (data) => {
		const response = await axios.post(authConfig.signUpUrl, data);
		response.then(
			(res) => {
	 ...
	 * Update user
	 */
	//knscdksdnfkjshgjkfdsgfffffffffffffffffffffffffff
